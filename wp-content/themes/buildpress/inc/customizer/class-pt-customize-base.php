...
class BuildPress_Customizer_Base {
	...
	*/
	public function register () {
		...
		$this->wp_customize->add_setting( new BuildPress_Customize_Setting_Dynamic_CSS( $this->wp_customize, 'header_text', array(
			'default' => '#dddddd',
			'css_map' => array(
				'color' => array(
					'.icon-box__title',
		...
		// individual sections
		$this->wp_customize->add_section( 'buildpress_section_logos', array(
